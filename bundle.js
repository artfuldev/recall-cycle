...
},{"@cycle/xstream-adapter":19,"xstream":372}],4:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"./ElementFinder":1,"./EventDelegator":2,"./fromEvent":7,"./isolate":11,"./utils":18,"@cycle/xstream-adapter":19,"matches-selector":20,"xstream":372}],5:[function(require,module,exports){
"use strict";
...
},{"xstream":372}],8:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"./MainDOMSource":4,"./VNodeWrapper":6,"./isolateModule":12,"./modules":16,"./transposition":17,"./utils":18,"@cycle/xstream-adapter":19,"snabbdom":65,"xstream":372}],14:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"@cycle/xstream-adapter":19,"xstream":372}],16:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":19,"xstream":372}],18:[function(require,module,exports){
"use strict";
...
},{"xstream":372}],20:[function(require,module,exports){
'use strict';
...
},{"dup":19,"xstream":372}],71:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./core":370}],373:[function(require,module,exports){
"use strict";
...
function reducers(actions) {
    ...
    var allowedReducer$ = xstream_1.default.merge(actions.newGame$.mapTo(function (state) {
        return state.set('allowed', false);
    }), actions.newGame$.compose(delay_1.default(4000)).mapTo(function (state) {
    ...
    var selectedReducer$ = xstream_1.default.merge(actions.newGame$.mapTo(function (state) {
    ...
    var overReducer$ = xstream_1.default.merge(actions.newGame$.mapTo(function (state) {
        return state.set('over', false);
    }), actions.selectCell$.mapTo(function (state) {
        var selected = state.get('selected') || [];
        return selected.length === 9 ? state.set('over', true) : state;
    }));
    var resultReducer$ = xstream_1.default.merge(actions.newGame$.mapTo(function (state) {
...
function view(state$) {
    var vtree$ = state$.map(function (state) {
        ...
        return dom_1.div('#root', [dom_1.div('.container', [dom_1.div('.title.bar', [dom_1.h1(['Recall']), dom_1.ul('.actions', [dom_1.li([dom_1.a('.new', 'New')]), dom_1.li([dom_1.a('.reset', 'Reset')])])]), dom_1.div('.before.grid', [dom_1.p(['Click on the nine tiles you see to win! Score: ' + score])]), dom_1.div('.panel', [dom_1.div('.grid', grid.map(function (x) {
            return dom_1.div('.cell' + (!allowed && !over && puzzle.indexOf(x) !== -1 ? '.highlighted' : '') + (allowed && !over && selected.indexOf(x) !== -1 ? '.selected' : '') + (over && correct.indexOf(x) !== -1 ? '.correct' : '') + (over && wrong.indexOf(x) !== -1 ? '.wrong' : '') + (over && missed.indexOf(x) !== -1 ? '.missed' : ''), {
                attrs: { 'data-index': x }
            }, [dom_1.span()]);
        }))])])]);
    });
...
},{"@cycle/dom":10,"@cycle/xstream-run":68,"babel-polyfill":71,"immutable":369,"xstream":372,"xstream/extra/delay":371}]},{},[373]);
